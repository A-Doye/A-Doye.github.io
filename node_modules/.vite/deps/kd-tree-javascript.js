...
var require_kdTree_min = __commonJS({
  "node_modules/kd-tree-javascript/kdTree-min.js"(exports) {
    !(function(t, n) {
      "function" == typeof define && define.amd ? define(["exports"], n) : n("object" == typeof exports ? exports : t);
    })(exports, function(t) {
      function n(t2, n2, o2) {
      ...
      o.prototype = { push: function(t2) {
        ...
        Array.isArray(t2) ? this.root = r(t2, 0, null) : (function(t3) {
          ...
          function n2(o3) {
            ...
            return t3[i3] < o3.obj[i3] ? n2(o3.left, o3) : n2(o3.right, o3);
          }
          function o2(t4) {
            function n3(t5, o3) {
              var i4, r3, l2, u2, h;
...
export default require_kdTree_min();
//# sourceMappingURL=kd-tree-javascript.js.map
